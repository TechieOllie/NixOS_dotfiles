...
foundation (boot/nix/networking/users/ssh/shell/fonts/nix-ld) every host
needs regardless of role, not a role itself. Future role-specific profiles (`desktop.nix`,
